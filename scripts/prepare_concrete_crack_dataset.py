...
from COIGAN.training.data.datasets_loaders import ConcreteCrackConglomerateDataset
...
def convert_severstal_dataset_to_jsonl(config: DictConfig):
    ...
    if not check_severstal_jsonl_dataset_health(config):
        ...
        SeverstalSteelDefectPreprcessor(
            ConcreteCrackConglomerateDataset(config.raw_dataset_dir),
...
@hydra.main(config_path='../configs/data_preparation', config_name='concrete_crack_dataset_preparation_test.yaml', version_base="1.1")
